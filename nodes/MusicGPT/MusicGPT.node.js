...
exports.MusicGPT = MusicGPT;
async function musicCreate(context, item, itemIndex) {
    ...
    const music_style = context.getNodeParameter('music_style', itemIndex);
    const lyrics = context.getNodeParameter('lyrics', itemIndex);
    const voice_id = context.getNodeParameter('voice_id', itemIndex);
    ...
    try {
        ...
        // @ts-ignores
        return context.helpers.constructExecutionMetaData(context.helpers.returnJsonArray(responseData), { itemData: { item: itemIndex } });
    }
    catch (error) {
        // @ts-ignore
...
//# sourceMappingURL=MusicGPT.node.js.map